...
<div class="flex flex-col space-y-4 pb-8 md:flex-row md:space-x-10">
  ...
  <div class="space-y-4">
    <h1 class="text-5xl font-extrabold md:text-6xl">Felipe Vega</h1>
    <h2 class="flex flex-wrap text-4xl font-medium md:text-5xl">Product Manager, Developer, and Leader.</h2>
  </div>
</div>
@endsection
